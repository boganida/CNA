...
try:
  ...
  # ~~~~ INSERT CODE ~~~~
  serverSocket = socket.socket(socket.AF_INET, socket.SOCK_STREAM) #IPv4
  # ~~~~ END CODE INSERT ~~~~
...
while True:
  ...
  try:
    # ~~~~ INSERT CODE ~~~~
    clientSocket, clientAddress = serverSocket.accept() ####################################   4
    # ~~~~ END CODE INSERT ~~~~
  ...
  # ~~~~ INSERT CODE ~~~~
  message_bytes = clientSocket.recv(BUFFER_SIZE) # method of getting http
  # ~~~~ END CODE INSERT ~~~~
  ...
  try:
    ...
    for line in cacheData:
      clientSocket.send(line.encode()) ######################## 6 string type ---->bytestream
    # ~~~~ END CODE INSERT ~~~~
    cacheFile.close()
    ...
    try:
      ...
      # ~~~~ INSERT CODE ~~~~
      originServerSocket.connect((address,80)) #default http 80
      # ~~~~ END CODE INSERT ~~~~
      ...
      # ~~~~ INSERT CODE ~~~~
      originServerRequest = f"GET {resource} HTTP/1.1" #resource version 1.1
